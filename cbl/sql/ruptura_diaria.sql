...
/* PROMOTOR*/
    ...
    /* ITENS */
     ...
     , "Motivo" as "Motivo"      
     , "Produto em Ruptura?" as "Produto em Ruptura"
...
AND t.tsk_scheduleinitialdatehour::DATE  >= (NOW()::DATE - ''07 day''::INTERVAL)
AND act.act_id in (536390)
...
(
    ...
    /* ITENS */
     ...
     , "Horário de Trabalho" VARCHAR(1000)
     , "Motivo" VARCHAR(1000)
     , "Observações" VARCHAR(1000)
     , "Produto em Ruptura?" VARCHAR(1000)
)