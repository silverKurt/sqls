...
--select * from bicbl."fat_bicbl_CadastrodePromotores" where "age_name" ilike '%raira%'
--select * from bicbl."fat_bicbl_BasedeRotas" where "i_rota_promotor_codigo" = '90003394' and "i_rota_nome" = 'RN05'
SELECT 
