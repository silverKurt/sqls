...
--	, proc.status /* UTILIZAR A COLUNA "status_processo" */
    ...
    /*Alteração do Dia 01/09/2020*/
    , COALESCE(TO_DATE(proc.data_da_baixa, 'YYYY-MM-DD'), NOW()::DATE) - TO_DATE(proc.data_de_distribuicao, 'YYYY-MM-DD') AS duracao_de_processo
